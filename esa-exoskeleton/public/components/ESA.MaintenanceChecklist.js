        ...
        <div id="mc-root" style="display:flex;flex-direction:column;width:100%;min-height:500px;background:#282828;border-radius:12px;overflow:hidden;">
          ...
          <div style="background:#32302f;border-bottom:1px solid #3c3836;padding:16px 20px;">
            ...
            <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:10px;">
              ...
              <div><label style="display:block;color:#a89984;font-size:9px;margin-bottom:4px;text-transform:uppercase;">Employee</label><input type="text" id="mc-emp" placeholder="Name..." style="width:100%;background:#282828;color:#ebdbb2;border:1px solid #3c3836;border-radius:4px;padding:6px 8px;font-size:11px;"></div>
