 ...
 * Source of truth: https://elements.ai-sdk.dev/components/terminal
 * Fetched verbatim from the official registry item
 * (/api/registry/terminal.json → registry/default/ai-elements/terminal.tsx).
 * Only change: the shadcn Button import points at this repo's
 * `@/components/ui/button` instead of the registry's `@/registry/default/ui/button`.
 * Everything else — compound API, context, theme, ANSI pipeline, autoscroll,
 * copy/clear, streaming cursor — is byte-identical to the published component.
 */
