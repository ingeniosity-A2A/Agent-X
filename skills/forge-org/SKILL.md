...
subsystem. It is the governed ingestion / asset-governance lifecycle for the
**Ava007 Vault**.
...
- **Orchestration stays outside Ava007.** The pipeline is infrastructure around the
  vault, not an Ava007 cognitive capability.
...
- Engine: `scripts/forged_vault.py` (rocksdict control plane + DuckDB intelligence).
- Housing: `modules/forge-org/data/` (raw/ forged/ vendor/ quarantine/ rocksdb/ vault.duckdb).
