...
/* ------------------------------------------------------------------ */
/* useBentoReveal — canonical UI8 entrance: batch fade-up + scale      */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/* useTilt3D — signature UI8 hover tilt with elastic spring-back       */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/* useCountUp — animated number when scrolled into view                */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/* BentoCard — base card: demo visual + title + desc + Discover        */
/* ------------------------------------------------------------------ */

interface BentoCardProps {
  title: string;
  desc: string;
  children: React.ReactNode; // demo visual
  span?: string; // extra grid classes e.g. "md:col-span-2"
  className?: string;
  buttonLabel?: string;
  buttonClassName?: string; // extra classes for the Discover pill (e.g. gradient-mask-btn)
  onButtonClick?: () => void;
}
...
/* ------------------------------------------------------------------ */
/* Shared micro-components used inside demo visuals                    */
/* ------------------------------------------------------------------ */
