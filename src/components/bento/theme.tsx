...
/* ------------------------------------------------------------------ */
/* Theme definitions — six color varieties                             */
/* ------------------------------------------------------------------ */
...
export function BentoProvider({ children }: { children: React.ReactNode }) {
  ...
  /* Restore persisted preferences after mount (SSR-safe; intentional setState) */
    ...
    (l: LayoutId) => {
      ...
      requestAnimationFrame(() => {
        Flip.from(state, {
          ...
          onComplete: () => {
            busy.current = false;
            /* layout shift invalidates ScrollTrigger positions */
...
/* ------------------------------------------------------------------ */
/* Floating control dock — theme dots + layout switcher                */
/* (mirrors the sidebar on bento.ui8.net)                              */
/* ------------------------------------------------------------------ */
  ...
  return (
    <div
      ...
      className="fixed z-50
        ...
        md:bottom-auto md:top-6 md:left-6 md:translate-x-0
        flex md:flex-col items-center gap-2
        rounded-3xl md:rounded-[22px] border p-2.5 backdrop-blur-xl"
      style={{
    ...
    >
      ...
      {/* layout switcher */}
      <div
        className="flex md:flex-col items-center gap-1.5 px-1"
        role="group"
